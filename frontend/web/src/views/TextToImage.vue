...
<template>
  <div class="text-to-image">
      ...
      <div class="page-header">
        <div class="header-left">
          <div class="breadcrumb">
            ...
            <span class="breadcrumb-item active">文本生图</span>
          </div>
          <h1>文本生图</h1>
        </div>
        ...
        <div class="left-panel">
          <div class="panel-card">
            <div class="card-header">
              <span class="card-title">提示词输入</span>
              <span class="card-extra">支持中英文</span>
            </div>
            <div class="prompt-area">
              <textarea
                v-model="prompt"
                class="prompt-input"
                placeholder="请输入您想要生成的图像描述，例如：一只可爱的橘猫坐在窗台上，阳光透过窗户洒在它身上，温暖的光线，高清摄影风格..."
                rows="5"
              ></textarea>
              <div class="prompt-footer">
                <div class="prompt-tools">
                  ...
                  <button class="tool-btn">🎲 随机</button>
                </div>
        ...
        <div class="right-panel">
          <div class="panel-card result-panel">
            ...
            <div v-if="generatedImages.length === 0" class="empty-result">
              ...
              <p class="empty-hint">输入提示词并选择模型后点击生成</p>
            </div>
              ...
              <div v-for="(img, index) in generatedImages" :key="index" class="result-item">
                ...
                <div class="result-overlay">
                  <div class="result-actions">
                    ...
                    <button class="action-btn primary" @click="editImage(img)">编辑</button>
    ...
    <InspirationLibrary type="text" @select="handleInspirationSelect" />
  </div>
</template>
